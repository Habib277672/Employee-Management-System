...
export const FailedTask = ({ data }) => {
  return (
    ...
    hover:scale-[1.02] hover:border-red-400
    hover:shadow-[0_0_14px_rgba(248,113,113,0.25)]
  "
    >
      {/* Header */}
      <div className="flex justify-between items-center">
        <span className="text-xs px-3 py-1 rounded-full bg-[#1c1c1c] border border-[#333] text-red-400 font-medium">
          {data.category}
        </span>
      ...
      <div className="mt-4">
        <button
          disabled
          className="
        w-full py-2 text-sm font-medium rounded-md cursor-not-allowed
